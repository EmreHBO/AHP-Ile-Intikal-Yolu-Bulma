 ...
 * @author huseyin
 */
public class Pencere14 extends javax.swing.JFrame {
    public double[][] diziyeDegerGonder= new double[2][2];
    public double[] egimdizisi3=new double[2];
    public double[] yolyapisidizisi=new double[2];
    public double[] guvenlikdizi=new double[2]; 
    /**
...
public void sonrakiIcinNesneOlustur(){
    Pencere15 nesne15=new Pencere15();
    nesne15.setVisible(true);
    for(int i=0;i<2;i++){
        nesne15.egimdizisi4[i]=egimdizisi3[i];
        nesne15.yolyapisidizisi4[i]=yolyapisidizisi[i];
        nesne15.guvenlikdizisi4[i]=guvenlikdizi[i];
            }
}  
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pencere14.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
