 ...
 * @author huseyin
 */
public class Pencere4 extends javax.swing.JFrame {
    public double[][] diziyeDegerGonder= new double[4][4];
    public double[] egimdizisi3=new double[4];
    public double[] yolyapisidizisi=new double[4];
    public double[] guvenlikdizi=new double[4]; 
    /**
     * Creates new form Pencere4
     */
    public Pencere4() {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Güvenlik Durumuna Göre Karşılaştırma Yap", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 18), new java.awt.Color(19, 46, 215))); // NOI18N
...
public void sonrakiIcinNesneOlustur(){
    Pencere5 nesne5=new Pencere5();
    nesne5.setVisible(true);
    for(int i=0;i<4;i++){
        nesne5.egimdizisi4[i]=egimdizisi3[i];
        nesne5.yolyapisidizisi4[i]=yolyapisidizisi[i];
        nesne5.guvenlikdizisi4[i]=guvenlikdizi[i];
            }
}  
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pencere4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
