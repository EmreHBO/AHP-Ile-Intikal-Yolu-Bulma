...
public class Pencere13 extends javax.swing.JFrame {
    public double[][] diziyeDegerGonder= new double[2][2];
    public double[] yolyapisidizi=new double[2];
    public double[] egimdizisi=new double[2];
...
public void sonrakiIcinNesneOlustur(){
    Pencere14 nesne14=new Pencere14();
    nesne14.setVisible(true);
    for(int i=0;i<2;i++){
        nesne14.yolyapisidizisi[i]=yolyapisidizi[i]; 
        nesne14.egimdizisi3[i]=egimdizisi[i];
            }
}  
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pencere13.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
