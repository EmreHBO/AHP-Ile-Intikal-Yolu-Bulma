 ...
 * @author huseyin
 */
public class Pencere11 extends javax.swing.JFrame {
 public double[][] diziyeDegerGonder= new double[4][4];
    public double[] egimdizisi5=new double[3]; 
    public double[] yolyapisidizisi5=new double[3]; 
    public double[] guvenlikdizisi5=new double[3]; 
    public double[] zamandizisi5=new double[3];   
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      kriterdizisi= gonder();
  double[][] goreceliOncelikDizisi=new double[3][4];
    
    double[] karsilastirmadizisi=new double[3];
       for(int i=0;i<3;i++){
   ...
   for(int j=0;j<dizi.length;j++){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pencere11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
