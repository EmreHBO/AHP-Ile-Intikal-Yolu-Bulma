 ...
 * @author huseyin
 */
public class Pencere9 extends javax.swing.JFrame {
    public double[][] diziyeDegerGonder= new double[3][3];
    public double[] egimdizisi3=new double[3];
    public double[] yolyapisidizisi=new double[3];
    public double[] guvenlikdizi=new double[3]; 
    /**
...
public void sonrakiIcinNesneOlustur(){
    Pencere10 nesne10=new Pencere10();
    nesne10.setVisible(true);
    for(int i=0;i<3;i++){
        nesne10.egimdizisi4[i]=egimdizisi3[i];
        nesne10.yolyapisidizisi4[i]=yolyapisidizisi[i];
        nesne10.guvenlikdizisi4[i]=guvenlikdizi[i];
            }
}  
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pencere9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
