 ...
 * @author huseyin
 */
public class Pencere16 extends javax.swing.JFrame {
 public double[][] diziyeDegerGonder= new double[4][4];
    public double[] egimdizisi5=new double[2]; 
    public double[] yolyapisidizisi5=new double[2]; 
    public double[] guvenlikdizisi5=new double[2]; 
    public double[] zamandizisi5=new double[2];   
    public double[]   kriterdizisi=new double[4]; 
    
    /**
     * Creates new form Pencere6
     */
    public Pencere16() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      kriterdizisi= gonder();
  double[][] goreceliOncelikDizisi=new double[2][4];
    
    double[] karsilastirmadizisi=new double[2];
       for(int i=0;i<2;i++){
   ...
   for(int j=0;j<dizi.length;j++){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pencere16.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
