 ...
 * @author huseyin
 */
public class Pencere18 extends javax.swing.JFrame {
public double[][] diziyeDegerGonder= new double[5][5];
    public double[] yolyapisidizi=new double[5];
    public double[] egimdizisi=new double[5];
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Yol Yapısına Göre Karşılaştırma Yap", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 18), new java.awt.Color(5, 75, 248))); // NOI18N
...
public void sonrakiIcinNesneOlustur(){
    Pencere19 nesne19=new Pencere19();
    nesne19.setVisible(true);
    for(int i=0;i<5;i++){
        nesne19.yolyapisidizisi[i]=yolyapisidizi[i]; 
        nesne19.egimdizisi3[i]=egimdizisi[i];
            }
}  
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pencere18.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
