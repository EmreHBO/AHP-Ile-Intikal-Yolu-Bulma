...
public class Pencere3 extends javax.swing.JFrame {
    public double[][] diziyeDegerGonder= new double[4][4];
    public double[] yolyapisidizi=new double[4];
    public double[] egimdizisi=new double[4];
    ...
    private void initComponents() {
        ...
        jLabel13.setText("2.Yolun 4.Yola ");
        ...
        jLabel14.setText("3.Yolun 4.Yola ");
...
public void sonrakiIcinNesneOlustur(){
    Pencere4 nesne4=new Pencere4();
    nesne4.setVisible(true);
    for(int i=0;i<4;i++){
        nesne4.yolyapisidizisi[i]=yolyapisidizi[i]; 
        nesne4.egimdizisi3[i]=egimdizisi[i];
            }
}  
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pencere3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
